...
if (cursor && ring) {
  ...
  document.addEventListener("mousemove", function(e) {
    ...
    // Use transform instead of top/left — not affected by scroll or overflow:hidden
  ...
  function attachCursorHover() {
    document.querySelectorAll("a,button,.cat-card,.product-card,.bs-item,.pay-option").forEach(function(el) {
  ...
  setTimeout(attachCursorHover, 400);
}
